                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open">
                        <a href="{{ route('gallery.index') }}" class="nav-link active">
                            <i class="fas fa-cubes"></i>
                            <p>Галерея<i class="right fas fa-angle-left"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('gallery.create') }}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Создать</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item menu-open">
                        <a href="{{ route('partner.index') }}" class="nav-link active">
                            <i class="fas fa-cubes"></i>
                            <p>Партнёры<i class="right fas fa-angle-left"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('partner.create') }}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Создать</p>
                                </a>
                            </li>
